...
class Triangle {
  ...
  render(title, textcolor, shapecolor) {
    return `<svg version='1.1' width="300" height="200"><Triangle cx="100" cy="100" rx="300" ry="100" fill='${shapecolor}'/><text x="150" y="125" font-size="60" text-anchor="middle" fill="${textcolor}">${title}</text></svg>`
  }
}
